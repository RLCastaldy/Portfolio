...
import profileImage from '../assets/profile.jpg'
  ...
  function AboutMe() {
    return (
      ...
      Though these are the primary technologies I have been exposed to, I am not shy about learning and embrace the growth that comes with each new experience.</h1>
    </header>
    );
  }
